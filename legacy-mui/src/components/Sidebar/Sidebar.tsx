...
export const SidebarHeader: React.FC<Omit<SidebarHeaderProps, "theme">> = ({
  variant,
  color,
  children,
}) => {
...
export const SidebarTitle: React.FC<Omit<SidebarTitleProps, "theme">> = ({
  variant,
  color,
  children,
}) => {
...
export const SidebarBody: React.FC<Omit<SidebarBodyProps, "theme">> = ({
  variant,
  color,
  children,
}) => {
...
export const SidebarFooter: React.FC<Omit<SidebarFooterProps, "theme">> = ({
  variant,
  color,
  children,
}) => {
