...
export const TableRoot = <T extends { id: string; [key: string]: any }>({
  columns,
  data,
  color = "primary",
  selectable = false,
...
export const TableCellComponent: React.FC<TableCellProps> = ({
  ...
  return (
    <TableCell align={align} padding={padding} theme={theme}>
      {children}
    </TableCell>
  );
};

export const TableHeaderCellComponent: React.FC<TableHeaderCellProps> = ({
  children,
  align,
  padding,
  sortable,
