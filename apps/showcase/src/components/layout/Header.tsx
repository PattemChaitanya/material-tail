      ...
      >
        <Toolbar style={{ padding: "0 24px", minHeight: "64px" }}>
          ...
          <Flex align="center" gap={24} className="desktop-nav">
            <Link to="/" style={{ color: "var(--text-primary)", textDecoration: "none", fontSize: "0.9rem", fontWeight: 500, padding: "6px 12px", borderRadius: "6px", backgroundColor: "var(--action-hover)" }}>Docs</Link>
            <Link to="/docs/button" style={{ color: "var(--text-secondary)", textDecoration: "none", fontSize: "0.9rem", fontWeight: 500 }}>Components</Link>
            <Link to="/theming" style={{ color: "var(--text-secondary)", textDecoration: "none", fontSize: "0.9rem", fontWeight: 500 }}>Themes</Link>
          </Flex>

          {/* Spacer to push the right-side icons to the edge */}
          <div style={{ flexGrow: 1 }} />

          <Flex gap={16} align="center">
            <a href="https://github.com/PattemChaitanya/material-tail" target="_blank" rel="noreferrer" className="desktop-nav" style={{ display: "flex", alignItems: "center", gap: "8px", color: "var(--text-secondary)", textDecoration: "none", fontSize: "0.9rem", fontWeight: 500 }}>
              GitHub
            ...
            <button 
              ...
              style={{ 
                display: "flex", alignItems: "center", background: "var(--input-filled-bg)", 
                borderRadius: "8px", padding: "6px 12px", width: "280px", 
                border: "1px solid var(--border-color)", cursor: "text", textAlign: "left" 
              }}
            >
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="var(--text-secondary)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ marginRight: "8px", flexShrink: 0 }}><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
              <span style={{ color: "var(--text-secondary)", fontSize: "0.9rem", flexGrow: 1, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>Search documentation...</span>
              <span style={{ fontSize: "0.7rem", color: "var(--text-secondary)", background: "var(--background-paper)", padding: "2px 6px", borderRadius: "4px", border: "1px solid var(--border-color)", flexShrink: 0, whiteSpace: "nowrap" }}>Ctrl + K</span>
            </button>
